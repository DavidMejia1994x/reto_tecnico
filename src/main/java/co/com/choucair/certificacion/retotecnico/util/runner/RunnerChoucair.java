package co.com.choucair.certificacion.retotecnico.util.runner;
 ...
 *  @sice 25/11/2020
 * */
public class RunnerChoucair extends Runner {
  private static final Logger LOGGER = LogManager.getLogger(RunnerChoucair.class.getName());
  private Class<CucumberWithSerenity> classValue;
  private CucumberWithSerenity cucumberWithSerenity;

  public RunnerChoucair(Class<CucumberWithSerenity> classValue)
