package co.com.choucair.certificacion.retotecnico.util.datos;
...
public class CargarDatos implements Task {
  private static final Logger LOGGER = LogManager.getLogger(co.com.choucair.certificacion.retotecnico.util.datos.CargarDatos.class.getName());
